...
extension Refresh.Header: View {
    ...
    public var body: some View {
        ...
        .anchorPreference(key: Refresh.HeaderAnchorKey.self, value: .bounds) {
			[.init(bounds: $0, position: nil, refreshing: self.refreshing)]
        }
		.transformAnchorPreference(key: Refresh.HeaderAnchorKey.self, value: .topLeading) { (value: inout [Refresh.HeaderAnchorKey.Item], anchor: Anchor<CGPoint>) in
			value[0].position = anchor
		}
    }
